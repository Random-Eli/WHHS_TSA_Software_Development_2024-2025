Public Class widgetTime
    Private Sub widgetTime_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub widgetTime_Paint(sender As Object, e As PaintEventArgs) Handles MyBase.Paint
